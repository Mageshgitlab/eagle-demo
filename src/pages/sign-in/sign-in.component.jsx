...
class SignIn extends Component {
  ...
  render() {
    return (
      <div class="login-div">
        <div class="title">OneMap</div>
        <div class="sub-title">Login</div>
        <div class="fields">
          <div class="username">
            <svg svg fill="#999" viewBox="0 0 20 20">
          ...
          <div class="password">
            <svg class="svg-icon" svg fill="#999" viewBox="0 0 20 20">
        ...
        <button class="signin-button" onClick={this.handleClick}>
          Login
        </button>
        <div class="link">
